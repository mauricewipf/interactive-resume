import{T as r,h as o,p as c,c as u}from"./tailwind.element.js";const x="";var p=Object.defineProperty,f=Object.getOwnPropertyDescriptor,n=(v,i,t,s)=>{for(var e=s>1?void 0:s?f(i,t):i,l=v.length-1,d;l>=0;l--)(d=v[l])&&(e=(s?d(i,t,e):d(e))||e);return s&&e&&p(i,t,e),e};let a=class extends r(x){constructor(){super(...arguments),this.isOpen=!0}toggle(){this.isOpen=!this.isOpen}render(){return o`
        ...
        `}};n([c({type:Boolean})],a.prototype,"isOpen",2);a=n([u("mauwi-map-overlay")],a);
